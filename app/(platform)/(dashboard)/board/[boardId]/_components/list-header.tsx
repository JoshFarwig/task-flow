            ...
            {isEditing ? (
                ...
                >
                    ...
                    <FormInput
                        ...
                        defaultValue={title}
                        className="text-sm px-[7px] py-1 h-7 font-meduim border-transparent hover:border-input 
                ...
                <div
                    ...
                    className="w-full text-sm px-2.5 py-1 h-7 font-meduim border-transparent"
                >
                    {title}
                </div>
            )}
